// src/pages/ProfessionalLandingPage.jsx
 ...
 // --- RealisticStarfield Component (Keep as is) ---
 const RealisticStarfield = ({
     starCount = 75, // Reduced star count
     layerCount = 3,
     baseSpeed = 0.05
 }) => {
     ...
     useGSAP(() => {
         ...
         gsap.fromTo(".realistic-star",
            { opacity: 0, scale: 0.5 },
            {
              ...
              duration: 1.5,
              stagger: {
                 each: 0.01, // Reduced stagger amount
                 from: "random"
              },
              ease: "power2.out",
              onComplete: function() {
 ...
 // --- ObstacleCard Component (Keep as is) ---
 ...
 // --- ImpactCard Component (Keep as is) ---
 ...
 const ProfessionalLandingPage = () => {
     ...
     // Shuffle the array to make the split less predictable (optional but good for UX)
     ...
     return (
         <div ref={containerRef} className="professional-landing-wrapper">
             <div className="professional-landing bg-transparent text-text relative z-10">
                 <RealisticStarfield /> {/* Simplified props */}
                  ...
                  <section className="snap-section section-4 min-h-screen flex flex-col items-center justify-center py-16 md:py-24 px-4 text-center relative overflow-hidden">
                      <div className="section-4-content relative z-10 w-full max-w-6xl">
                          <div className="section-4-intro">
                             <h3 className="font-heading text-5xl md:text-6xl mb-8 animated-gradient-heading drop-shadow-lg"> {/* Applied Option 1 style */}
                                 Our Impact
                             </h3>
                          </div>
                           <div className="v4-impact mb-16">
                               <div className="flex flex-col gap-6">
                                    ...
                                    <LogoMarquee images={marqueeImages1} speed={25} direction="left" />
                                    <LogoMarquee images={marqueeImages2} speed={25} direction="right" />
                                    {/* --- --- */}
                               </div>
                           </div>
