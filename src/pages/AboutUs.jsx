...
const AboutUsPage = () => {
  ...
  useGSAP(() => {
    ...
    // Spotlight effect for founder cards
  ...
  return (
    <div ref={containerRef} className="about-us-v4-container">
      <div className="v4-header animate-section">
      ...
      <div className="v4-founders-grid animate-section">
      ...
      <div className="v4-cta animate-section">
