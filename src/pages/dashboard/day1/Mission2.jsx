    ...
    <div className="w-full max-w-xl text-center animate-in zoom-in-95 duration-300">
      ...
      <div className="relative mb-10">
        ...
        <div className="bg-white text-background p-6 rounded-[2rem] rounded-bl-sm relative shadow-[0_20px_50px_rgba(255,255,255,0.2)]">
          <p className="font-heading text-2xl sm:text-3xl font-black leading-tight uppercase tracking-tight text-indigo-900 border-4 border-dashed border-indigo-200 p-4 rounded-xl">
            "What was Your Favourite Hobby When you Were my Age?"
          </p>
